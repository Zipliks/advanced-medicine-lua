...
_G['CargoManager'].SellBackPurchasedItems = function(storeIdentifier, itemsToSell, client) end
...
---@param client Barotrauma.Networking.Client
_G['CargoManager'].OnNewItemsPurchased = function(storeIdentifier, newItems, client) end
