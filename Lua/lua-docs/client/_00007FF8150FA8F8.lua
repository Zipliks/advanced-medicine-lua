...
---`Field Private Instance`
---@field loopStartTime System.Double|number
---`Field Private Instance`
---@field loopSound System.Boolean|boolean
---`Field Private Instance`
...
---`Field Private Instance`
---@field playSoundOnRequiredItemFailure System.Boolean|boolean
---`Field Private Instance`
...
---`Field Private Static`
---@field LastMuffleCheckTime System.Double|number
---`Field Public Static`
