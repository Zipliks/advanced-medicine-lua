...
---@field LastControlled System.Boolean|boolean
...
---@field CrewListIndex System.Int32|integer
---`Getter Public Instance`
---<br/>`Setter Public Instance`
---@field Head Barotrauma.CharacterInfo.HeadInfo
---`Getter Public Instance`
...
---@param returnParent System.Boolean|boolean
...
---@param targetWidth System.Single|number
---@param flip? System.Boolean|boolean
---@param evaluateDisguise? System.Boolean|boolean
...
_G['CharacterInfo'].ClientRead = function(speciesName, inc) end
