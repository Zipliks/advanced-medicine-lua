...
---@field UpgradePreviewScale System.Single|number
...
---`Getter Public Instance`
---<br/>`Setter Private Instance`
---@field ImpactSoundTag System.String|string
---`Getter Public Instance`
---<br/>`Setter Private Instance`
---@field ShowInStatusMonitor System.Boolean|boolean
---`Getter Public Instance`
---<br/>`Setter Private Instance`
...
_G['ItemPrefab'].DrawPlacing = function(spriteBatch, placeRect, scale, spriteEffects) end
