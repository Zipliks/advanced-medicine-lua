...
---`Field Private Instance`
---@field tileDiscovered System.Boolean[,]|System.Boolean|boolean[]
---`Field Private Instance`
---@field connectionHighlightState System.Single|number
---`Field Private Instance`
---@field tooltip System.Nullable*1System*ValueTuple*2Microsoft*Xna*Framework*Rectangle*2Barotrauma*RichString
---`Field Private Instance`
---@field pendingSubInfo System.ValueTuple*1Barotrauma*SubmarineInfo*1System*Single
---`Field Private Instance`
---@field beaconStationActiveText Barotrauma.RichString
---`Field Private Instance`
---@field beaconStationInactiveText Barotrauma.RichString
---`Field Private Instance`
---@field hudVisibility System.Single|number
---`Field Private Instance`
---@field cameraNoiseStrength System.Single|number
---`Field Public Instance`
...
---@param removeFromAdjacentLocations? System.Boolean|boolean
...
_G['Map'].Update = function(deltaTime, mapContainer) end

---`Method Public Instance`
---@param spriteBatch Microsoft.Xna.Framework.Graphics.SpriteBatch
---@param mapContainer Barotrauma.GUICustomComponent
_G['Map'].Draw = function(spriteBatch, mapContainer) end
...
---`Method Private Instance`
---@param location Barotrauma.Location
---@param prevName System.String|string
---@param change Barotrauma.LocationTypeChange
