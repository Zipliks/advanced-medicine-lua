...
---`Field Private Instance`
---@field containedSpriteDepths System.Single-arr|System.Single|number[]
---`Field Private Instance`
...
---@field ContainedSpriteDepth System.Single|number
---`Getter Public Instance`
---<br/>`Setter Public Instance`
---@field UILabel System.String|string
---`Getter Public Instance`
---<br/>`Setter Public Instance`
---@field IndicatorStyle Barotrauma.GUIComponentStyle
---`Getter Public Instance`
---<br/>`Setter Public Instance`
---@field ContainedStateIndicatorStyle System.String|string
---`Getter Public Instance`
---<br/>`Setter Public Instance`
---@field ContainedStateIndicatorSlot System.Int32|integer
---`Getter Public Instance`
---<br/>`Setter Public Instance`
---@field ShowContainedStateIndicator System.Boolean|boolean
---`Getter Public Instance`
---<br/>`Setter Public Instance`
---@field ShowConditionInContainedStateIndicator System.Boolean|boolean
---`Getter Public Instance`
---<br/>`Setter Public Instance`
---@field ShowTotalStackCapacityInContainedStateIndicator System.Boolean|boolean
---`Getter Public Instance`
---<br/>`Setter Public Instance`
---@field KeepOpenWhenEquipped System.Boolean|boolean
---`Getter Public Instance`
---<br/>`Setter Public Instance`
---@field MovableFrame System.Boolean|boolean
---`Getter Public Instance Virtual`
...
_G['Components']['ItemContainer'].Draw = function(spriteBatch, editing, itemDepth) end

---`Method Public Instance`
---@param spriteBatch Microsoft.Xna.Framework.Graphics.SpriteBatch
---@param itemDepth System.Single|number
_G['Components']['ItemContainer'].DrawContainedItems = function(spriteBatch, itemDepth) end

---`Method Public Instance Virtual`
---@param character Barotrauma.Character
---@param deltaTime System.Single|number
---@param cam Barotrauma.Camera
_G['Components']['ItemContainer'].UpdateHUD = function(character, deltaTime, cam) end
